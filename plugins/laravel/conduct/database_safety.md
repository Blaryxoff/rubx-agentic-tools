...
Never run the following commands without explicit written approval in the current session:
...
This runs only pending migrations without touching existing data.
