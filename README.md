...
A model-agnostic toolkit of AI-agent plugins for product teams. Add it as a submodule to generate scoped AI context (
skills, conduct, hooks, permissions) for Claude Code, Cursor, and Codex.
